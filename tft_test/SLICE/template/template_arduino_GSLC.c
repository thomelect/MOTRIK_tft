...
#define MAX_ELEM_PG1 8                // # Elems total on page
...
void InitGUIslice_gen()
{
  ...
  if (!gslc_FontSet(&m_gui, E_FREESANSBOLD12, GSLC_FONTREF_PTR, &FreeSansBold12pt7b, 1))
  {
    return;
  }
  if (!gslc_FontSet(&m_gui, E_FREESANSBOLD18, GSLC_FONTREF_PTR, &FreeSansBold18pt7b, 1))
  {
    return;
  }
  ...
  // Create E_ELEM_TEXT6 runtime modifiable text
  static char m_sDisplayText6[4] = "100";
  pElemRef = gslc_ElemCreateTxt(&m_gui, E_ELEM_TEXT6, E_PG1, (gslc_tsRect){720, 10, 73, 34},
                                (char *)m_sDisplayText6, 4, E_BUILTIN20X32);
  ...
  static char m_sDisplayText7[4] = "100";
  pElemRef = gslc_ElemCreateTxt(&m_gui, E_ELEM_TEXT7, E_PG1, (gslc_tsRect){730, 50, 62, 28},
                                (char *)m_sDisplayText7, 4, E_FREESANSBOLD18);
  ...
  // Create E_COUNTER2 runtime modifiable text
  static char m_sDisplayText4[4] = "100";
  pElemRef = gslc_ElemCreateTxt(&m_gui, E_COUNTER2, E_PG3, (gslc_tsRect){720, 10, 73, 34},
                                (char *)m_sDisplayText4, 4, E_BUILTIN20X32);
  gslc_ElemSetTxtAlign(&m_gui, pElemRef, GSLC_ALIGN_MID_MID);
  gslc_ElemSetCol(&m_gui, pElemRef, GSLC_COL_GRAY, ((gslc_tsColor){25, 70, 153}), ((gslc_tsColor){25, 70, 153}));
  gslc_ElemSetTxtEnc(&m_gui, pElemRef, GSLC_TXT_ENC_UTF8);
