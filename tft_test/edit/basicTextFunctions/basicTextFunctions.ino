...
void setup() 
{
  ...
  tft.print("www.buydisplay.com");
  tft.getCursor(&x, &y);
  tft.drawFastHLine(50, (y + 75), (x - 50), RA8875_RED);
  tft.fillRect(50, (y + 75), (x - 50), 50, RA8875_GREEN);
  tft.fillCurve(50 - 5, (y + 75) + 5, 15, 15, 100, RA8875_WHITE);
  tft.getCursor(&x, &y);
  tft.fillCurve(50 + 15, (y + 75) + 35, 15, 25, 100, RA8875_WHITE);
