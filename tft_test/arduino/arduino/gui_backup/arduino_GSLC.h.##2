...
enum {E_ELEM_BOX1,E_ELEM_BOX2,E_ELEM_BOX3,E_ELEM_BOX4,E_ELEM_BOX5
      ...
      ,E_ELEM_RAMPGAUGE3,E_ELEM_RINGGAUGE1,E_ELEM_SPINNER2,E_ELEM_TEXT1
...
//<InitGUI !Start!>
  ...
  // Add Spinner element
  pElemRef = gslc_ElemXSpinnerCreate(&m_gui,E_ELEM_SPINNER2,E_PG3,&m_sXSpinner2,
    (gslc_tsRect){410,360,63,20},0,99,0,1,E_BUILTIN5X8,20,&CbSpinner);
