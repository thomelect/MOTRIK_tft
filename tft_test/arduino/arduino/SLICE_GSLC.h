...
// ------------------------------------------------
//<Enum !Start!>
enum {E_PG1,E_PG2,E_PG3,E_POP_KEYPAD_NUM};
enum {E_ELEM_BOX1,E_ELEM_BOX2,E_ELEM_BOX3,E_ELEM_BOX4,E_ELEM_BOX5
      ...
      ,E_ELEM_BTN7,E_ELEM_BTN8,E_ELEM_BTN9,E_ELEM_NUMINPUT1
      ,E_ELEM_NUMINPUT2,E_ELEM_RADIALGAUGE1,E_ELEM_RAMPGAUGE3
      ,E_ELEM_RINGGAUGE1,E_ELEM_SPINNER3,E_ELEM_TEXT1,E_ELEM_TEXT2
      ,E_ELEM_TEXT3,E_ELEM_TOGGLE1,E_ELEM_KEYPAD_NUM};
// Must use separate enum for fonts with MAX_FONT at end to use gslc_FontSet.
enum {E_BUILTIN15X24,E_BUILTIN5X8,E_FREESANSBOLD12,E_FREESANSBOLD9
      ,MAX_FONT};
//<Enum !End!>
...
extern gslc_tsElemRef* m_pElemSpinner3;
...
//<InitGUI !Start!>
  ...
  static char m_sInputNumber2[11] = "100";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_NUMINPUT2,E_PG1,(gslc_tsRect){304,340,191,26},
    (char*)m_sInputNumber2,11,E_BUILTIN15X24);
  ...
  static char m_sInputNumber1[11] = "100";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_NUMINPUT1,E_PG3,(gslc_tsRect){304,270,191,26},
    (char*)m_sInputNumber1,11,E_BUILTIN15X24);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetTxtMargin(&m_gui,pElemRef,5);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  gslc_ElemSetClickEn(&m_gui, pElemRef, true);
  ...
  // Add Spinner element
  pElemRef = gslc_ElemXSpinnerCreate(&m_gui,E_ELEM_SPINNER3,E_PG3,&m_sXSpinner3,
    (gslc_tsRect){490,370,63,20},0,99,0,1,E_BUILTIN5X8,20,&CbSpinner);
